...
class WebSocketConfigurer(private val userService: UserService,
                          private val userInfoService: UserInfoService) : WebSocketMessageBrokerConfigurer {
...
//        registry.setUserDestinationPrefix("/user/");
    ...
    internal fun webSocketUserInterceptor(): WebSocketUserInterceptor {
        return WebSocketUserInterceptor(baseConfig(), accountConfig(), userService, userInfoService)
    }
